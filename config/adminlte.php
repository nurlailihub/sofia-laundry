...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Transaksi',
            'route' => 'admin.transaksis.index',
            'icon' => 'fas fa-fw fa-cash-register',
        ],
        ['header' => 'INVENTORI'],
        [
            'text' => 'Stok Barang',
            'route' => 'admin.stok_barangs.index',
            'icon' => 'fas fa-fw fa-boxes',
        ],
        ['header' => 'LAPORAN'],
        [
            'text' => 'Laporan Transaksi',
            'route' => 'admin.laporan.transaksi.index',
            'icon' => 'fas fa-fw fa-file-invoice',
        ],
        [
            'text' => 'Laporan Pelanggan',
            'route' => 'admin.laporan.pelanggan.index',
