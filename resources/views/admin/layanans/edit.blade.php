    ...
    <div class="col-lg-7">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-edit mr-1"></i> Form Edit Layanan</h3>
            </div>
            <form action="{{ route('admin.layanans.update', $layanan->id_layanan) }}" method="POST">
                ...
                <div class="card-body">
                        ...
                        <div class="d-flex" style="gap: 1rem;">
                            <div class="custom-control custom-radio">
                                <input type="radio" id="tipe_kg" name="tipe_harga" value="kg"
                                    ...
                                    {{ old('tipe_harga', $layanan->tipe_harga) === 'kg' ? 'checked' : '' }}
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" id="tipe_satuan" name="tipe_harga" value="satuan"
                                    class="custom-control-input"
                                    {{ old('tipe_harga', $layanan->tipe_harga) === 'satuan' ? 'checked' : '' }}
                                    onchange="updateSatuanLabel()">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <span class="input-group-text" id="satuanLabel">
                                    / {{ old('tipe_harga', $layanan->tipe_harga) === 'satuan' ? 'pcs' : 'kg' }}
                                </span>
                            </div>
                            @error('harga_per_kg')
                            <span class="invalid-feedback">{{ $message }}</span>
                        ...
                        <small class="text-muted" id="satuanHint">
                            {{ old('tipe_harga', $layanan->tipe_harga) === 'satuan'
                                ? 'Harga yang dikenakan per pcs/item.'
